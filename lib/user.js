...
command.builder = {
    ...
    l: {
        alias: 'list',
        describe: 'Only list all broadcast URIs and exit',
        type: 'boolean'
    }
};
        ...
        .then(function(data) {
            ...
            if (argv.list) {
                for (var i = 0; i < data.broadcasts.length; i++) {
                    ...
                    console.log(broadcast.ddateAired + '; ' + length + '; https://www.younow.com/' + data.username + '/' + broadcast.broadcastId + '/' + data.user.userId + '/');
                }
                process.exit(0);
            }
